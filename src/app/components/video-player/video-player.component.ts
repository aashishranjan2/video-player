...
export class VideoPlayerComponent implements OnInit, OnDestroy {
  ...
  /**
   * @description queueChosenVideoToPlay() gets the videos from playlist and updates videosCount and
   * calls setNextVideoToPlay()
   */
  queueChosenVideoToPlay(): void {
  ...
  /**
   * @description playSelectedList() gets called once user selects playlist to play and,
   * calls setVideosToPlay which accepts playlist to set videos from
   * @param <playList>
   */
  playSelectedList(playListName) {
   ...
   */
  playSelectedVideoFromPlaylist(video: VideoModel) {
